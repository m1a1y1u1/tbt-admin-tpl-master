    ...
    <form action="" class="login-form">
      <div class="m-list-group">
        <div class="m-list-group-item">
          <input type="text" placeholder="Username" class="m-input" v-model="userForm.userName">
        </div>
        <div class="m-list-group-item">
          <input type="password" placeholder="Password" class="m-input" v-model="userForm.password">
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    handleLogin () {
      ...
      self.$axiosPOST(self.$api.login, self.userForm, success);
    }
  }
}
</script>
