...
<m-navbar :theme="theme.theme.headerTheme">
  ...
  <m-nav>
    <m-nav-item><a href="https://www.lanyueos.com" target="_blank">投不投APP管理平台</a></m-nav-item>
  </m-nav>
  <m-nav align="right">
    ...
    <m-nav-item padding="0">
      <m-dropdown align="right" v-if="user" padding="0 10px">
        ...
        <m-dropdown-panel>
          ...
          <m-dropdown-item @click.stop.prevent.native="handleLogout">退出账号</m-dropdown-item>
        </m-dropdown-panel>
      </m-dropdown>
    </m-nav-item>
